...
Extend the `loss` function used to train the the deep SDM developed in **B** by constraining it with the process-based model developed in **A**. The extended loss should have the form
