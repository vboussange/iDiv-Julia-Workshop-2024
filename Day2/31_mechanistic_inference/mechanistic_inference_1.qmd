...
sol_true = solve(prob, alg; saveat=tsteps)
# Plot simulation.
plot(sol_true)
```
...
We can now define a new parameter vectors, which will consist of the ODE model parameters as well as the neural net parameters
...
Excellent! Now let's investigate what did the neural network learn!
